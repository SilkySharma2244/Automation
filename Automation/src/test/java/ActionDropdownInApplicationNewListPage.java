...
public class ActionDropdownInApplicationNewListPage {

	WebDriver driver;
	Properties pro=new  Properties();
		
	
	public ActionDropdownInApplicationNewListPage(WebDriver driver) {
		this.driver=driver;
	}
...
//	   
// WebElement scrollArea = driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div/div[2]/div"));
//	   
...
WebElement scrollArea2 = driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div/div[2]/div"));
	...
	Thread.sleep(5000);
	driver.findElement(By.xpath("//*[@id=\"collapseOne_0\"]/table/tbody/tr[1]/td[14]/div/button")).click();//submit
	Thread.sleep(5000);
...
//		 Assert.assertEquals(text,"Succeed!");//pending
		...
		WebElement scrollArea3 = driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div/div[2]/div"));
			...
			driver.findElement(By.xpath("//*[@id=\"collapseOne_0\"]/table/tbody/tr[1]/td[14]/div/div/a[3]")).click();//view status
		     ...
		     Assert.assertEquals(text3,"Offers available");//pending to test
		        	 ...
		        	 Actions actn8=new Actions(driver);
						...
						WebElement scrollArea4 = driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div/div[2]/div"));
				          ...
				          System.out.println(text5);
			               Assert.assertEquals(text5,"Offer URL successfully copied");}
							...
							WebElement scrollArea5 = driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div/div[2]/div"));
								...
								WebElement scrollArea6 = driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div/div[2]/div"));
									...
									WebElement scrollArea7 = driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div/div[2]/div"));
										...
										WebElement scrollArea8 = driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div/div[2]/div"));
