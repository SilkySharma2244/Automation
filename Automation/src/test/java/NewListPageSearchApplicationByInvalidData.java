...
public class NewListPageSearchApplicationByInvalidData {
	...
	public NewListPageSearchApplicationByInvalidData(WebDriver driver) {
		this.driver=driver;
	}
   ...
   public void searchInvalidata() throws Exception {
	   ...
	   Thread.sleep(5000);
		...
		Thread.sleep(5000);
		//All Status
		driver.findElement(By.xpath("//*[@id=\"ajax_content\"]/div[1]/div/div[1]/form/div[1]/div[1]/div/div/input")).sendKeys("jinney");
