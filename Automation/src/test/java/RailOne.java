...
public class RailOne {
	...
	public RailOne(WebDriver driver) {
		this.driver=driver;
	}
...
//			Thread.sleep(12000);
//			   try {
//	String actual3=driver.findElement(By.xpath("/html/body/div[6]/span[3]")).getText();
//	String expected3="Login Successful";
...
//			driver.findElement(By.xpath("/html/body/nav/div[3]/ul/li[4]/ul/li[1]//a[@href='/vendors']")).click();	
			Thread.sleep(3000);////*[@id="table_content"]/div/table/tbody/tr/td[8]/div/button
...
//					 driver.get(newurl);
			...
			//driver.findElement(By.xpath("//*[@id=\"short_url\"]")).sendKeys(click1);
				//	 driver.switchTo().window(tabs.get(0));
				
//				
//				JavascriptExecutor js81 = (JavascriptExecutor) driver;
//				js81.executeScript("window.open()");
//				driver.get(value);
...
//		String altex=	alt.getText();
//		System.out.println(altex);
//			}catch(Exception e) {
//				System.out.println(e.getMessage());
//			}
//		String elt=driver.findElement(By.xpath("//*[@id=\"sms_history\"]/div/div/div[1]/h5")).getText();
//		System.out.println(elt);
//		driver.findElement(By.xpath("//*[@id=\"sms_history\"]/div/div/div[3]/button")).click();
				     // get  window id of current window
//			WebElement button=driver.findElement(By.xpath("//*[@id=\"sms_history\"]/div/div/div[3]/button"));
//			
//			Actions action5 =new Actions (driver);
//			action5.moveToElement(button).click().build().perform();
//			
//			Thread.sleep(3000); 
//			String urltext=driver.findElement(By.xpath("//*[@id=\"short_url\"]")).getText();
//			System.out.println(urltext);
		///	driver.navigate().to("https://viewmylink.com/");
			

			//viewmylink.com/n68AiQ
		
		
		
				   
//				   Thread.sleep(2000);
//				   driver.findElement(By.xpath("//*[@id=\"submit-btn2\"]")).click();
//				   driver.navigate().to("https://demo.fitsyn.com/applications");
//				   Thread.sleep(2000);
//				   driver.findElement(By.xpath("//*[@id=\"table_content\"]/div[2]/div/div[2]/table/tbody/tr[1]/td[16]/div/button")).click();
//				   driver.findElement(By.xpath("//*[@id=\"table_content\"]/div[2]/div/div[2]/table/tbody/tr[1]/td[16]/div/div/a[4]")).click();
//////				   
//				   Thread.sleep(5000);
//				   try {
