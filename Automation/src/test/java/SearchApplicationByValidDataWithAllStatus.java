...
public class SearchApplicationByValidDataWithAllStatus {
	...
	public SearchApplicationByValidDataWithAllStatus(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void validDataAllStatus() throws Exception {
