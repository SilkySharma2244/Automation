...
public class CustomOffersPage {
	...
	public CustomOffersPage(WebDriver driver) {
		this.driver=driver;
	}
	...
	//String exptitle="Fitsyn UAT | Custom Offers";
	   ...
	   ////*[@id="lenders_list"]/tbody/tr[1]/td[4]/label/span
		...
		driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[2]/div/input")).sendKeys("mock+265@evenfinancial.com");}
			...
			JavascriptExecutor js3 = (JavascriptExecutor) driver;
			   js3.executeScript("window.scrollBy(0,50)");
				...
				//   WebElement element12 = driver.findElement(By.xpath("/html/body/div[4]/div[1]/div/div/div/div/section/div/div[3]/div/div[2]/ul/li[1]/a"));
							...
							slt71.selectByValue("cash_back");
							 ...
							 JavascriptExecutor js83 = (JavascriptExecutor) driver;
							   ...
							   action23.moveToElement(driver.findElement(By.cssSelector("#submit-btn"))).click().build().perform();
		                        try {
							   Thread.sleep(10000);
							   JavascriptExecutor js891 = (JavascriptExecutor) driver;
							   js891.executeScript("window.scrollBy(0,500)");
							 //  WebElement element121 = driver.findElement(By.xpath("/html/body/div[4]/div[1]/div/div/div/div/section/div/div[3]/div/div[2]/ul/li[1]/a"));
							//  Actions action3211 =new Actions(driver);
							//  action3211.moveToElement(element121).click().build().perform();
							  Thread.sleep(5000);
							  JavascriptExecutor js8711 = (JavascriptExecutor) driver;
							   js8711.executeScript("window.scrollBy(0,50)");}
		                        catch(Exception e) {
		                        	e.printStackTrace();
		                        }
							   
	}///html/body/div[4]/div[1]/div/div/div/div/section/div/div[3]/div/div[2]/ul/li[1]/a
	
	
	
	//note:disable all and able all
	//
