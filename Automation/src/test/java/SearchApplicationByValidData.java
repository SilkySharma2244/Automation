...
public class SearchApplicationByValidData {
	...
	public SearchApplicationByValidData(WebDriver driver) {
		this.driver=driver;
	}
...
public void validDatasearchDifferentFilters() throws Exception {
